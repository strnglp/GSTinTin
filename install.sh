...
# Usage: gemstone [--dev] [CHAR] [PORT]
#   --dev  Run from \$HOME/Projects/GSTinTin instead of the installed copy.
...
if [[ \$DEV_MODE -eq 1 ]]; then
    GSTIN_DIR="\${GSTIN_DIR:-\$HOME/Projects/GSTinTin}"
    echo "Running in dev mode from: \$GSTIN_DIR"
else
